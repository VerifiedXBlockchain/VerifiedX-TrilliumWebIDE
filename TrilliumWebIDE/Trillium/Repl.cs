...
namespace TrilliumWebIDE.Trillium
{
	public abstract class Repl
	{
		...
		public EvaluationResult? Run(string text)
		{
			...
			{
				var result = EvaluateSubmission(text);
		...
		protected abstract EvaluationResult? EvaluateSubmission(string text);
